...
$$\frac{1}{r}\frac{\partial}{\partial{r}}(kr\frac{\partial{T}}{\partial{r}})+\frac{\partial}{\partial{z}}(k\frac{\partial{T}}{\partial{z}})=-f, \quad 0<r<a,\ 0<z<l$$
Поставим следующие граничные условия:
$T = T_1 \quad \text{при} \quad r = a,$
$T = T_2 \quad \text{при} \quad z = l,$
$-k \frac{dT}{dz} = q \quad \text{при} \quad z = 0.$
$\frac{dT}{dr} = 0 \quad \text{при} \quad r = 0.$

Обезразмеренная задача имеет вид:

$$ \frac{1}{\hat r}\frac{\partial}{\partial \hat r} \left(\hat r \frac{\partial \hat T}{\partial \hat r}\right) + \frac{\partial^{2} \hat T}{\partial \hat z^{2}}= -\hat f = -\frac{a^{2} f}{k T_{1}}, \qquad 0 < \hat r < 1,\; 0 < \hat z < \frac{l}{a}, $$
с граничными условиями:
$\frac{d \hat T}{d \hat r} = 0 \quad \text{при} \quad \hat r = 0,$
$\hat T = 0 \quad \text{при} \quad \hat r = 1,$
$\frac{d \hat T}{d \hat z} = -\hat q = -\frac{a q}{k T_{1}} \quad \text{при} \quad \hat z = 0,$
$\hat T = \theta = \frac{T_{2} - T_{1}}{T_{1}} \quad \text{при} \quad \hat z = \frac{l}{a}.$
...
![[]]
![[]]
Итоговый результат: $\omega_{opt}=1.7$.
