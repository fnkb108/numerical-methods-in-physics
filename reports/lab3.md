...
$$ \mathop{\text{div}}(\rho\,\mathbf{v}\,\varphi) = \mathop{\text{div}}(\Gamma \nabla \varphi) + S $$
...
С увеличением коэффициента диффузии импульс заметно сглаживается (что хорошо видно на двумерных распределениях $\phi(x,y)$ при различных значениях диффузии): максимум $ϕ$
